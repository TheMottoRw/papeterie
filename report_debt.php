        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Report Table -->
                    <h6 id="report-title">Debt Report From <?php echo htmlspecialchars(substr($start_date,0,10)); ?>
                    ...
                    <table class="table table-bordered" id="salesTable">
                        ...
                        <tr>
                            ...
                            <th>Profit</th>
                            <th>Paid</th>
                            <th style="color: darkred">Debt </th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach ($salesData as $k=>$sale){ ?>
                            <tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">Total Debt:<b><font color="red"><?php echo number_format($total_debt, 2); ?> RWF</font></b> </div>
                        <br>
